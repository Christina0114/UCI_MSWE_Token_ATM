...
public class EarnServiceI implements EarnService {
    ...
    @Async
    public void syncTokensOnDeadline() {
        ...
        scheduler.schedule(() -> {
            ...
            if (quizGrades != null && studentMap != null) {
                ...
                for (String user_id : usersToUpdate) {
                    Optional<TokenCountEntity> optional = tokenRepository.findById(Integer.parseInt(user_id));
                    if (optional.isPresent()) {
                        TokenCountEntity entity = optional.get();
                        entity.setToken_count(entity.getToken_count() + 2);
    ...
    private List<String> getSurveyCompletedEmailAddresses(String surveyId, String fileId) throws IOException, JSONException {
