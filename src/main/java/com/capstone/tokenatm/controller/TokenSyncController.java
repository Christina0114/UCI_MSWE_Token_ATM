...
public class TokenSyncController {
    ...
    public HashMap<Object, Object> getUsers() throws IOException, JSONException {
        URL url = new URL("https://canvas.eee.uci.edu/api/v1/courses/50350/users?per_page=50&enrollment_type=student");
